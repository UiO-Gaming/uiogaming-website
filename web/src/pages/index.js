    ...
    <header id="hjem" className="text-center">
      ...
      <div className="container">
        <div className="header-container">
          <img src={logo} />
          <h1>UiO Gaming</h1>
          <p>En hobbyforening som ønsker skape et sosialt miljø rundt gaming og E-sport på UiO</p>
        </div>
      </div>
    </header>
      ...
      <div className="container">
        <div className="split">
          ...
          <div>
            ...
            <p>UiO Gaming er en forening med hovedfokus på å danne et inkluderende fellesskap rundt videospill og E-sport. Hos oss er det enkelt å skaffe seg venner, ettersom alle har felles interesser. Vi arrangerer ukentlige spillkvelder og fysiske sosiale arrangementer, som for eksempel brettspillkvelder og sosiale sammenkomster. Vår hovedkanal er en aktiv Discord-server hvor man kan møte nye folk med felles interesser og game med andre studenter.</p>
            
            <div className="join-button-container">
              <h3>Interessert?</h3>
              <a href="https://discord.gg/556mseV" target="_blank" className="join-button">Bli med!</a>
            </div>
          </div>
              ...
              <a href={"blog/" + post.slug.current}>
                <article className="split blogcard">
                  ...
                  <div className="blogcard-content">
                    ...
                    <p>Publisert: <time>{post.publishedAt}</time></p>
                    <p>{post.excerpt}</p>
                  </div>
      ...
      <div className="container">
        ...
        <div className="contact-container">
          <div className="contact">
            <FaAt />
            <a href="mailto:styret.uiogaming@gmail.com" target="_blank">E-post</a>
          </div>
          <div className="contact">
            <FaDiscord />
            <a href="https://discord.gg/PqsgXbnds4" target="_blank">Discord</a>
          </div>
          <div className="contact">
            <FaFacebook />
            <a href="https://www.facebook.com/UiO-Gaming-113445760510985" target="_blank">Facebook</a>
          </div>
          <div className="contact">
            <FaInstagram />
            <a href="https://www.instagram.com/uio_gaming/" target="_blank">Instagram</a>
          </div>
          <div className="contact">
            <FaGithub />
            <a href="https://github.com/UiO-Gaming" target="_blank">GitHub</a>
          </div>
        </div>
